<?php
    ...
    public function verifyOTP($username, $email, $password, $tokencode, $otp, $csrf_token){
        if($otp == $_SESSION['OTP']){
            ...
            echo "<script>alert('If appears that the OTP you entered is invalid'); window.location.href = '../../../verify-otp.php'; </script>";
            exit;
        }
    }
        ...
        public function adminSignin($email, $password, $csrf_token)
    {
        ...
        function send_email($email, $message, $subject, $smtp_email, $smtp_password){
            ...
            $mail->setFrom($smtp_email, "Jahziel");
